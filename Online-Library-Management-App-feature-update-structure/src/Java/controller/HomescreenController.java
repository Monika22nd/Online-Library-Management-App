...
public class HomescreenController {
    ...
    private void openAdminPanel() {
        try {
            ...
            SceneHelper.switchScene(stage, "/resources/ui/AdminPanel.fxml", "Admin Panel", controller -> {
    ...
    private void renderBooks(List<Book> books) {
        ...
        try {
            for (Book book : books) {
                FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/resources/ui/BookCard.fxml"));
    ...
    private void handleViewBorrowedClicked(ActionEvent event) {
        try {
            ...
            SceneHelper.switchScene(stage, "/resources/ui/BorrowedBooks.fxml", "Sách đã mượn", controller -> {
    ...
    private void handleLogoutClicked(ActionEvent event) {
        try {
            ...
            SceneHelper.switchScene(stage, "/resources/ui/LoginView.fxml", "Login", null);
        } catch (IOException e) { e.printStackTrace(); }
    }
}